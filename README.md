...
This project is based on simple-react-full-stack at https://github.com/crsandeep/simple-react-full-stack, which provided the boilerplate to build a full stack web application using React, Node.js, Express and Webpack. It is also configured with webpack-dev-server, eslint, prettier and babel.
